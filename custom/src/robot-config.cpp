...
motor right_chassis2 = motor(PORT15, ratio6_1, true);
...
rotation horizontal_tracker = rotation(PORT6, true);
...
double turn_kp = 1, turn_ki = 0, turn_kd = 1000;
double heading_correction_kp = 0.001, heading_correction_ki = 0, heading_correction_kd = 3;
...
double vertical_tracker_diameter = 2.20; // Diameter of the vertical tracker wheel (in inches)
